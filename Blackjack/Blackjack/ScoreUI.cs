...
namespace Blackjack
{
    public class ScoreUI
    {
        ...
        private bool _areDealerValuesVisible = false;
        ...
        /// <param name="valueVisible">are the dealer cards visible</param>
        public void setCardValues(List<int> playerCardValues, List<int> dealerCardValues, bool valueVisible)
        {
            _playerCardValues = "value" + (playerCardValues.Count > 1 ? "s:" : playerCardValues.Count > 1 ? ":" : ":\n0");
            ...
            if (valueVisible)
            {
                _dealerCardValues = "value" + (dealerCardValues.Count > 1 ? "s: " : playerCardValues.Count > 1 ? ":" : ":\n0");
